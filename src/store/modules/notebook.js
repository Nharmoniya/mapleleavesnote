import Notebook from '@/api/notebookApi.js'
...
const actions = {
  ...
  addNotebook({ commit }, payload) {
    return Notebook.createNotebooks({ title: payload.title })
      .then(res => {
  ...
  updateNotebook({ commit }, payload) {
    return Notebook.updateNotebooks(payload.notebookId, { title: payload.title })
      .then(res => {
  ...
  deleteNotebook({ commit }, payload) {
    return Notebook.deleteNotebooks(payload.notebookId)
      .then(res => {
